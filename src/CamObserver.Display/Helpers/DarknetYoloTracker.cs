...
namespace CamObserver.Display.Helpers
{
    public class DarknetYoloTracker
    {
        ...
        public void Process(IList<ObjectInfo> Targets, Rectangle SelectArea)
        {
            ...
            {
                IsAdded = true;
                var pos = new PointF(newItem.P1.X + Math.Abs(newItem.P2.X - newItem.P1.X) / 2, newItem.P1.Y + Math.Abs(newItem.P2.Y - newItem.P1.Y) / 2);
