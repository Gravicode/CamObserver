...
using CamObserver.Services.Grpc;
...
// db first
//builder.Services.AddDbContext<CamObserverDB>(option =>
...
try
{
    logger.Information("Starting CamObserver.Service API");
}
catch (Exception ex)
{
    logger.Fatal(ex, "Fatal error when starting CamObserver.Service API");
}
...
void ConfigureServices(IServiceCollection services, IConfiguration Configuration)
{
    ...
    */
    ...
    CamObserverDB db = new CamObserverDB();
