...
namespace CamObserver.UWP.Common
{
    ...
    public static class ImageHelper
    {
        ...
        public static BitmapDecoder CreateBitmapDecoderFromPath(string image)
        {
            ...
            return ImageHelper.CreateBitmapDecoderFromStorageFile(file);
        }
        ...
        {
            var file = StorageFile.GetFileFromApplicationUriAsync(new Uri(image)).GetAwaiter().GetResult();
            return ImageHelper.CreateSoftwareBitmapFromStorageFile(file);
        }
    }

    public static class RenderingHelpers
    {
        public static void BindSoftwareBitmapToImageControl(Image imageControl, SoftwareBitmap softwareBitmap)
        {
